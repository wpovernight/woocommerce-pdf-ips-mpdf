...
use WPO\IPS\Mpdf\Vendor\setasign\Fpdi\PdfParser\CrossReference\CrossReference;
    ...
    public function readValue($token = null, $expectedType = null)
    {
        ...
        if ($token === false) {
            if ($expectedType !== null) {
                throw new Type\PdfTypeException('Got unexpected token type.', \WPO\IPS\Mpdf\Vendor\setasign\Fpdi\PdfParser\Type\PdfTypeException::INVALID_DATA_TYPE);
            }
            return false;
        }
        switch ($token) {
