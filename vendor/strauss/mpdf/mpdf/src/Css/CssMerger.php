...
use WPO\IPS\Mpdf\Vendor\Mpdf\Exception\InvalidArgumentException;
...
class CssMerger
{
	...
	/**
	 * @var \WPO\IPS\Mpdf\Vendor\Mpdf\Css\NormalizeProperties
	 */
	private $normalizeProperties;

	/**
	 * @var \WPO\IPS\Mpdf\Vendor\Mpdf\Css\InlineStyleParser
	 */
	private $inlineStyleParser;

	/**
	 * @var \WPO\IPS\Mpdf\Vendor\Mpdf\Css\SelectorParser
	 */
	private $selectorParser;

	/**
	 * @var \WPO\IPS\Mpdf\Vendor\Mpdf\Css\InlinePropertyConverter
	 */
	...
	/**
	 * @var \WPO\IPS\Mpdf\Vendor\Mpdf\Css\BorderMerger
	 */
