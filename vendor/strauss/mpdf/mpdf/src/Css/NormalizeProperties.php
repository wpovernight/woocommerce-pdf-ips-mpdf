...
class NormalizeProperties
{
    ...
    protected function processFontFamilyProperty($propertyKey, $value)
    {
        ...
        foreach ($fontList as $fontName) {
            ...
            if (in_array($fontName, $this->mpdf->fontdata, true) || in_array($fontName, $this->mpdf->available_unifonts, true) || in_array($fontName, $this->mpdf->sans_fonts, true) || in_array($fontName, $this->mpdf->serif_fonts, true) || in_array($fontName, $this->mpdf->mono_fonts, true) || $this->mpdf->onlyCoreFonts && in_array($fontName, ['courier', 'times', 'helvetica', 'arial'], true) || in_array($fontName, ['sjis', 'uhc', 'big5', 'gb'], true)) {
