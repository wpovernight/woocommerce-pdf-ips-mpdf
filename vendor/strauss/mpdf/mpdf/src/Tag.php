...
class Tag
{
	...
	/**
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Mpdf $mpdf
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Cache $cache
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\CssManager $cssManager
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Form $form
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Otl $otl
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\TableOfContents $tableOfContents
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\SizeConverter $sizeConverter
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \WPO\IPS\Mpdf\Vendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \WPO\IPS\Mpdf\Vendor\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'WPO\IPS\Mpdf\Vendor\Mpdf\Tag\\';
