 ...
 */
class Code39 extends \WPO\IPS\Mpdf\Vendor\Mpdf\Barcode\AbstractBarcode implements \WPO\IPS\Mpdf\Vendor\Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $printRatio, $extended, $checksum)
	{
		...
		if ($code === false) {
			throw new \WPO\IPS\Mpdf\Vendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid CODE39 barcode value "%s"', $code));
		}
